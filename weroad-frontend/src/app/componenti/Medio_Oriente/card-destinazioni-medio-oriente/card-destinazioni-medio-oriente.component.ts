...
@Component({
  selector: 'app-card-destinazioni-medio-oriente',
  templateUrl: './card-destinazioni-medio-oriente.component.html',
  styleUrls: ['./card-destinazioni-medio-oriente.component.css']
})
export class CardDestinazioniMedioOrienteComponent implements OnInit {

  nameCountry = [
    { title1: "Turchia" },
    { title2: 'Giordania' },
    { title3: 'Emirati Arabi' },
    { title4: 'Oman' },
    { title5: 'Paesi inusuali tutte da scoprire' }
  ];

  countries = ['Turchia', 'Giordania', 'Emirati Arabi', 'Oman'];
