...
@Component({
  selector: 'app-card-destinazioni-est-europa',
  templateUrl: './card-destinazioni-est-europa.component.html',
  styleUrls: ['./card-destinazioni-est-europa.component.css']
})
export class CardDestinazioniEstEuropaComponent implements OnInit{


  countries = ['Europa dell\'Est'];
