...
@Component({
  selector: 'app-card-destinazioni-centro-america',
  templateUrl: './card-destinazioni-centro-america.component.html',
  styleUrls: ['./card-destinazioni-centro-america.component.css']
})
export class CardDestinazioniCentroAmericaComponent implements OnInit {

  nameCountry = [
    { title1: "Cuba" },
    { title2: 'Messico' },
    { title3: 'Costa Rica' },
    { title4: 'Repubblica Dominicana' },
    { title5: 'Panama' },
    { title6: 'Paesi inusuali tutti da scoprire' }
  ];

  countries = ['Cuba', 'Messico', 'Costa Rica', 'Rep.Dominicana', 'Panama'];
