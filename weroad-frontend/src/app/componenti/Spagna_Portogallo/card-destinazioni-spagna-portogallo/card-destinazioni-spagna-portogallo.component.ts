...
@Component({
  selector: 'app-card-destinazioni-spagna-portogallo',
  templateUrl: './card-destinazioni-spagna-portogallo.component.html',
  styleUrls: ['./card-destinazioni-spagna-portogallo.component.css']
})
export class CardDestinazioniSpagnaPortogalloComponent implements OnInit {
  nameCountry = [
    { title1: "Spagna" },
    { title2: 'Portogallo' }
  ];

  countries = ['Spagna', 'Portogallo'];
