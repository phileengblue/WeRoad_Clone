...
@Component({
  selector: 'app-card-destinazioni-sud-est-asiatico',
  templateUrl: './card-destinazioni-sud-est-asiatico.component.html',
  styleUrls: ['./card-destinazioni-sud-est-asiatico.component.css']
})
export class CardDestinazioniSudEstAsiaticoComponent implements OnInit {



  nameCountry =[
    {
      title1:"Indonesia" //Indosnesia
    },
    {
      title2:'Thailandia'
    },
    ...
    {
      title5:'Malesia e Singapore'
    },
    {
      title6:'Laos e Cambogia'
    },
  ]



  countries = ['Indonesia', 'Thailandia', 'Vietnam', 'Filippine', 'Malesia e Singapore', 
    'Laos e Cambogia'];
