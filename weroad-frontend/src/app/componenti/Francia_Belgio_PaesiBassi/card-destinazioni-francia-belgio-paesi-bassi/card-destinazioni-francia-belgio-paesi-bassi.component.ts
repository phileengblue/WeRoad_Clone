...
@Component({
  selector: 'app-card-destinazioni-francia-belgio-paesi-bassi',
  templateUrl: './card-destinazioni-francia-belgio-paesi-bassi.component.html',
  styleUrls: ['./card-destinazioni-francia-belgio-paesi-bassi.component.css']
})
export class CardDestinazioniFranciaBelgioPaesiBassiComponent  implements OnInit{



  countries = ['Francia', 'Belgio', 'Paesi Bassi'];
