...
@Component({
  selector: 'app-card-destinazioni-oceania',
  templateUrl: './card-destinazioni-oceania.component.html',
  styleUrls: ['./card-destinazioni-oceania.component.css']
})
export class CardDestinazioniOceaniaComponent implements OnInit {
